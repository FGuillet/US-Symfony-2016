 ...
 */
class Category extends \US\CatalogBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'image', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'properties', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'products', '' . "\0" . 'US\\CatalogBundle\\Entity\\Category' . "\0" . 'idImage');
        }
